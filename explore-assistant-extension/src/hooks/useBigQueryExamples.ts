      ...
      const query = await core40SDK.ok(
        core40SDK.run_inline_query({
          ...
          body: {
            ...
            fields: [`explore_assistant_examples.explore_id`, `explore_assistant_examples.examples`, `explore_assistant_refinement_examples.examples`, `explore_assistant_samples.samples`,`explore_assistant_examples.connection`],
          }
        })
      )
